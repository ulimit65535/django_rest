...
SECRET_KEY = 'django-insecure-lt0(#1fv-3)l3^ue18*$_!-xm^yv_atqqrar2o-7fj_d$m(fk$'
...
INSTALLED_APPS = [
    ...
    'notify.apps.NotifyConfig',  # 消息接收模块
]
...
REST_FRAMEWORK = {
    # 异常处理
    'EXCEPTION_HANDLER': 'django_rest.utils.exceptions.exception_handler',
}